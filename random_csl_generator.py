...
if len(sys.argv) == 1:
    ...
    number_of_numbers = int(input('Please enter the desired number of integers: '))
elif len(sys.argv) == 4:
    n1 = int(sys.argv[1])
    n2 = int(sys.argv[2])
...
# Fill a list with random numbers in the given range
random_numbers = [random.randint(lower, upper) for i in range(number_of_numbers)]

# Join all of the values in the list into a single string
